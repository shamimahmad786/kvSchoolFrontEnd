...
BASE_URL_DATA_TEACHER: 'http://10.25.26.251:8020/api/teacher/',
	...
	BASE_URL_DATA_DASHBOARD: 'http://10.25.26.251:8020/api/dashboard/',
	BASE_URL_DATA_USER:'http://10.25.26.251:8020/meuser/api/user/',
	BASE_URL_DATA_SURPLUS_TRANSFER:'http://10.25.26.251:8020/api/transfer/',
	LOGIN_URL_JWT:'http://10.25.26.251:8020/api/login/',
	LOGOUT_URL:'http://10.25.26.251:8020/meauth/logout?returnTo=http://localhost:8020/',
	LOGIN_URL_INDIVIDUAL:'http://10.25.26.251:8020/meauth/oauth/authorize?response_type=code&user_oauth_approval=true&client_id=teacher&redirect_uri=http://localhost:8020/teacher/profile&scopes=read',
	LOGIN_URL_COMMON:'http://10.25.26.251:8020/tDashboard',
	LOGIN_URL_COMMON_LOCAL1:'',
	LOGIN_URL_COMMON_LOCAL2:'',
	LANDING_PAGE_URL:'http://10.25.26.251:8020/',
	AUTH_GUARD_HREF:'http://10.25.26.251:8020/teacher/profile',
	AUTH_GUARD_HREF1:'http://10.25.26.251:8020/meauth/logout?returnTo=http://localhost:8020/',
	BASE_URL_MEUSER:'http://10.25.26.251:8020/meuser/api/user/',
  BASE_URL_REPORT:'http://10.25.26.35:8020/api/kvsreport/',
	BASE_URL_DATA_MASTER1:'http://10.25.26.251:8020/unee-api/v1/master/',
	BASE_URL_DATA_MAPPING:'http://10.25.26.251:8020/unee-api/v1/mapping/',  
  BASE_URL_DATA_USERMANAGEMENT:'http://10.25.26.251:8020/api/usermanagement/',
  BASE_URL_DATA_USERMAPPING:'http://10.25.26.251:8020/api/usermapping/',  
  BASE_URL_DATA_KVCONTROLER:'http://10.25.26.251:8020/api/kvscontroller/',
  BASE_URL_DATA_REPORTCONTROLER:'http://10.25.26.251:8020/api/reportcontroller/',
  BASE_URL_DATA_TRANSFERPROCESS:'http://10.25.26.251:8020/api/transferprocess/',
  BASE_URL_DATA_API_TICKET:'http://10.25.26.251:8015/api/ticket/',
  BASE_URL_DATA_API_FILETRANSFER:'http://10.25.26.251:8020/api/filetransfer/',
