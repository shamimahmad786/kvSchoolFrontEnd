...
BASE_URL_DATA_TEACHER: 'http://10.25.26.251:8014/api/teacher/',
	...
	BASE_URL_DATA_USER:'http://10.25.26.251:8014/meuser/api/user/',
	BASE_URL_DATA_SURPLUS_TRANSFER:'http://10.25.26.251:8014/api/transfer/',
	LOGIN_URL_JWT:'http://10.25.26.251:8014/api/login/',
	LOGOUT_URL:'http://10.25.26.251:8014/meauth/logout?returnTo=http://localhost:8014/',
	LOGIN_URL_INDIVIDUAL:'http://10.25.26.251:8014/meauth/oauth/authorize?response_type=code&user_oauth_approval=true&client_id=teacher&redirect_uri=http://localhost:8014/teacher/profile&scopes=read',
	LOGIN_URL_COMMON:'http://10.25.26.251:8014/tDashboard',
	LOGIN_URL_COMMON_LOCAL1:'',
	LOGIN_URL_COMMON_LOCAL2:'',
	LANDING_PAGE_URL:'http://10.25.26.251:8014/',
	AUTH_GUARD_HREF:'http://10.25.26.251:8014/teacher/profile',
	AUTH_GUARD_HREF1:'http://10.25.26.251:8014/meauth/logout?returnTo=http://localhost:8014/',
	BASE_URL_MEUSER:'http://10.25.26.251:8014/meuser/api/user/',
  BASE_URL_REPORT:'http://10.25.26.35:8014/api/kvsreport/',
  ...
  // BASE_URL_DATA_TEACHER: 'http://10.25.26.35:8014/api/teacher/',
	...
	// BASE_URL_DATA_USER:'http://10.25.26.35:8014/meuser/api/user/',
	// BASE_URL_DATA_SURPLUS_TRANSFER:'http://10.25.26.35:8014/api/transfer/',
	// LOGIN_URL_JWT:'http://10.25.26.35:8014/api/login/',
	// LOGOUT_URL:'http://10.25.26.35:8014/meauth/logout?returnTo=http://localhost:8014/',
	// LOGIN_URL_INDIVIDUAL:'http://10.25.26.35:8014/meauth/oauth/authorize?response_type=code&user_oauth_approval=true&client_id=teacher&redirect_uri=http://localhost:8014/teacher/profile&scopes=read',
	// LOGIN_URL_COMMON:'http://10.25.26.35:8014/tDashboard',
	// LOGIN_URL_COMMON_LOCAL1:'',
	// LOGIN_URL_COMMON_LOCAL2:'',
	// LANDING_PAGE_URL:'http://10.25.26.35:8014/',
	// AUTH_GUARD_HREF:'http://10.25.26.35:8014/teacher/profile',
	// AUTH_GUARD_HREF1:'http://10.25.26.35:8014/meauth/logout?returnTo=http://localhost:8014/',
	// BASE_URL_MEUSER:'http://10.25.26.35:8014/meuser/api/user/',
  // BASE_URL_REPORT:'http://10.25.26.35:8014/api/kvsreport/',
	...
	// BASE_URL_DATA_TEACHER: 'http://localhost:8014/api/teacher/',
	// BASE_URL_DATA_TEACHER_TRANSFER:'http://localhost:8014/api/transprofile/',
	// BASE_URL_DATA_MASTER: 'http://localhost:8014/api/master/',
	// BASE_URL_DATA_QUESTION: 'http://localhost:8014/api/question/',
	// BASE_URL_DATA_SURVEY: 'http://localhost:8014/api/survey/',
	// BASE_URL_DATA_EXPERIENCE: 'http://localhost:8014/api/experience/',
	// BASE_URL_DATA_PROMOTION: 'http://localhost:8014/api/promotion/',
	// BASE_URL_DATA_QUALIFICATION: 'http://localhost:8014/api/qualification/',
	// BASE_URL_DATA_AWARDS: 'http://localhost:8014/api/awards/',
	// BASE_URL_DATA_TRANSFER: 'http://localhost:8014/api/transfer/',
	// BASE_URL_DATA_DASHBOARD: 'http://localhost:8014/api/dashboard/',
	// BASE_URL_DATA_USER:'http://localhost:8014/meuser/api/user/',
	// BASE_URL_DATA_SURPLUS_TRANSFER:'http://localhost:8014/api/transfer/',
	// LOGIN_URL_JWT:'http://localhost:8014/api/login/',
	// LOGOUT_URL:'http://localhost:8014/meauth/logout?returnTo=http://localhost:8014/',
	// LOGIN_URL_INDIVIDUAL:'http://localhost:8014/meauth/oauth/authorize?response_type=code&user_oauth_approval=true&client_id=teacher&redirect_uri=http://localhost:8014/teacher/profile&scopes=read',
	// LOGIN_URL_COMMON:'http://localhost:8014/tDashboard',
	// LOGIN_URL_COMMON_LOCAL1:'',
	// LOGIN_URL_COMMON_LOCAL2:'',
	// LANDING_PAGE_URL:'http://localhost:8014/',
	// AUTH_GUARD_HREF:'http://localhost:8014/teacher/profile',
	// AUTH_GUARD_HREF1:'http://localhost:8014/meauth/logout?returnTo=http://localhost:8014/',
	// BASE_URL_MEUSER:'http://localhost:8014/meuser/api/user/',
  // BASE_URL_REPORT:'http://localhost:8014/api/kvsreport/',
	// BASE_URL_DATA_MASTER1:'http://localhost:8014/unee-api/v1/master/',
	// BASE_URL_DATA_MAPPING:'http://localhost:8014/unee-api/v1/mapping/',
...
//  BASE_URL_DATA_USER: 'https://demopgi.udiseplus.gov.in/MOE-RAD-TEACHER-V1/api/user/',
