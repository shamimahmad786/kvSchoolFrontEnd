...
@Component({
  selector: 'app-station-wise-school-detail',
  templateUrl: './station-wise-school-detail.component.html',
  styleUrls: ['./station-wise-school-detail.component.css']
})
export class StationWiseSchoolDetailComponent implements OnInit {
  ...
  search(){
    debugger
    let request={};
    this.outSideService.getStationWiseSchoolCount(request,this.loginUserNameForService).subscribe((res)=>{
  ...
  getRegionStationList(res:any){
    debugger
   // this.stationSchoolCountByRegion=res;
    ...
    var groubedByEnrolmentDateResult=groupByEnrolementDate(res, 'region_name')
