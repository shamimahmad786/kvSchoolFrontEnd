...
export class BasicProfileComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.basicProfileForm = this.fb.group({
      ...
      'socialCatagory': new FormControl('', Validators.required),
...
// }
     ...
     "teacherEmployeeCode":this.employeeCode
      ...
      if(res){
        ...
        this.basicProfileForm.patchValue({
          ...
          socialCatagory: this.emplyeeData['teacherSocialCatagory'],
  ...
  submit(){
        var data={
          ...
          "teacherSocialCatagory": this.basicProfileForm.value.socialCatagory,
